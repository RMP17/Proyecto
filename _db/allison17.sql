...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2019 a las 13:48:14
...
(55, '2019-03-09', '0.00', '500.00', NULL, NULL, NULL, NULL, 1, 18, NULL, 'ef');
...
--
ALTER TABLE `compra`
  MODIFY `id_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `detalle_compra`
  MODIFY `id_detalle_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `detalle_venta`
  MODIFY `id_detalle_venta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
