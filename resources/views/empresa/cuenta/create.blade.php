<!DOCTYPE html>
<html dir="empresa/cliente" lang="en">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					...
					@endif
					{!!Form::open(array('class' => 'form-horizontal', 'url' => 'cuenta','method' => 'POST', 'autocomplete' => 'off'))!!}
						{{Form::token()}}
						<div class="card-body">
							<h4 class="card-title">Datos de registro de la Cuenta Bancaria</h4>
							<div class="form-group row">
								<label for="txtEntidad" class="col-sm-3 text-right control-label col-form-label">Entidad: </label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtEntidad" placeholder="El nombre de la entidad bancaria aquí" name="txtEntidad">
								</div>
							</div>
							<div class="form-group row">
								<label for="txtNroCuenta" class="col-sm-3 text-right control-label col-form-label">Nro. Cuenta : </label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtNroCuenta" placeholder="El número de la cuenta bancaria aquí" name="txtNroCuenta">
								</div>
							</div>
							<div class="form-group row">
