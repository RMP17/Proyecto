<html>
	...
	<body>
		<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-edit-caja_chica-{{$c -> id_caja_chica}}">
			@if (count($errors) > 0)
			...
			@endif
			{!!Form::model($c, ['method' => 'PATCH', 'route' => ['cajachica.update', $c -> id_caja_chica]])!!}
			{{Form::token()}}
					...
					<div class="modal-content">
						...
						<div class="modal-body">	
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtMontoApertura" value="{{$c -> monto_apertura}}" placeholder="00.00" name="txtMontoApertura" onkeypress="return ValidarDecimalTecleado(event, this.id)" onblur="ValidarDecimalPegado(event, this.id)">
								</div>
							</div>
						</div>
						<div class="form-group row">
