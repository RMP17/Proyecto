<html>
	...
	<body>
		<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-create-caja_chica">
			@if (count($errors) > 0)
			...
			@endif
			{!!Form::open(array('class' => 'form-horizontal', 'url' => 'cajachica', 'method' => 'POST', 'autocomplete' => 'off'))!!}
			{{Form::token()}}
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"> Registrar caja chica </h4>
						...
						<div class="modal-body">	
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtMontoApertura" placeholder="00.00" name="txtMontoApertura" onkeypress="return ValidarDecimalTecleado(event, this.id)" onblur="ValidarDecimalPegado(event, this.id)">
								</div>
							</div>
							<div class="form-group row">
