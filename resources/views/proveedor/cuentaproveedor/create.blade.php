		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					...
					{!!Form::open(array('class' => 'form-horizontal', 'url' => 'cuentaproveedor','method' => 'POST', 'autocomplete' => 'off'))!!}
						{{Form::token()}}
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtEntidad" placeholder="La entidad bancaría aquí" name="txtEntidad">
								</div>
							</div>
							<div class="form-group row">
								<label for="txtNroCuenta" class="col-sm-3 text-right control-label col-form-label">Nro. Cuenta : </label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtNroCuenta" placeholder="El número de la cuenta aquí" name="txtNroCuenta">
								</div>
							</div>
							<div class="form-group row">
