		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					...
					{!!Form::model($cuenta,['method'=>'PATCH','route'=>['cuentaproveedor.update',$cuenta->id_cuenta]])!!}
						{{Form::token()}}
						<div class="card-body">
							<h4 class="card-title">Modificar cuenta bancaria del proveedor</h4>
							<div class="form-group row">
								<label for="txtEntidad" class="col-sm-3 text-right control-label col-form-label">Entidad: </label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtEntidad" placeholder="La entidad bancaria aquí" name="txtEntidad" value="{{$cuenta->entidad}}">
								</div>
							</div>
							<div class="form-group row">
								<label for="txtNroCuenta" class="col-sm-3 text-right control-label col-form-label">Nro. Cuenta : </label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtNroCuenta" placeholder="El número de la cuenta aquí" name="txtNroCuenta" value="{{$cuenta->nro_cuenta}}">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row" hidden="" >
								...
								<div class="col-sm-9">
									<div class="col-md-9">
										<input type="text" class="form-control" id="cbxProveedor" value="{{$cuenta->id_proveedor}}" name="cbxProveedor">
									</div>
								</div>
							</div>
						</div>		
