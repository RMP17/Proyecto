...
<html dir="proveedor" lang="en">
	...
	<body>
		...
		<div class="container-fluid">
			...
			<!-- Start Page Content -->
			<!-- ============================================================== -->
			<h2> Datos del proveedor: {{$proveedor -> razon_social}} </h2>
			<div class="row">
				<div class="col-md-6">
					<div class="card">
						@if (count($errors) > 0)
						...
						{!!Form::model($proveedor, ['method' => 'PATCH', 'route' => ['proveedor.update', $proveedor -> id_proveedor]])!!}
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="txtRazonSocial" placeholder="Razón social del proveedor aquí" name="txtRazonSocial" value="{{$proveedor->razon_social}}">
									</div>
								</div>
								<div class="form-group row">
									<label for="txtNit" class="col-sm-3 text-right control-label col-form-label">NIT (*): </label>
									<div class="col-sm-9">
										<input type="text" class="form-control" id="txtNit" placeholder="El NIT del Proveedor aquí" name="txtNit" value="{{$proveedor->nit}}">
									</div>
								</div>
								<div class="form-group row">
									<label for="txtTelefono" class="col-sm-3 text-right control-label col-form-label">Teléfono : </label>
									<div class="col-sm-9">
										<input type="text" value="{{$proveedor->telefono}}" class="form-control" id="txtTelefono" placeholder="Número telefónico del proveedor aquí" name="txtTelefono" onkeypress="return ValidarNumeroTecleado(event)" onblur="ValidarNumeroPegado(event, this.id)">
									</div>
								</div>
								<div class="form-group row">
									<label for="txtCelular" class="col-sm-3 text-right control-label col-form-label">Celular : </label>
									<div class="col-sm-9">
										<input type="text" value="{{$proveedor->celular}}" class="form-control" id="txtCelular" placeholder="Número del celular del proveedor aquí" name="txtCelular" onkeypress="return ValidarNumeroTecleado(event)" onblur="ValidarNumeroPegado(event, this.id)">
									</div>
								</div>
								<div class="form-group row">
									<label for="txtCorreo" class="col-sm-3 text-right control-label col-form-label" id="lblCorreo">Correo : </label>
                                    <div class="col-sm-9">
										<input type="text" value="{{$proveedor->correo}}" class="form-control" id="txtCorreo" placeholder="E-mail del proveedor aquí" name="txtCorreo" onblur="ValidarCorreo(event, this.id)">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="txtSitioWeb" value ="{{$proveedor->sitio_web}}" placeholder="Sitio web del proveedor aquí" name="txtSitioWeb" onblur="ValidarSitioWeb(event, this.id)">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="txtDireccion" placeholder="Dirección del proveedor aquí" name="txtDireccion" value="{{$proveedor->direccion}}">
									</div>
								</div>
								<div class="form-group row">
									<label for="txtRubro" class="col-sm-3 text-right control-label col-form-label">Rubro : </label>
									<div class="col-sm-9">
										<input type="text" class="form-control" id="txtRubro" placeholder="El rubro del proveedor aquí" name="txtRubro" value="{{$proveedor->rubro}}">
									</div>
								</div>
							<div class="form-group row">
