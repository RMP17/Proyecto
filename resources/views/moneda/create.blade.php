<html>
	...
	<body>
		<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-create-moneda">
			@if (count($errors) > 0)
			...
			@endif
			{!!Form::open(array('class' => 'form-horizontal', 'url' => 'moneda', 'method' => 'POST', 'autocomplete' => 'off'))!!}
			{{Form::token()}}
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"> Registrar nueva moneda </h4>
						...
						<div class="modal-body">	
							<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="txtNombre" placeholder="El nombre de la moneda que desea registrar aquí" name="txtNombre">
									</div>
							</div>
							<div class="form-group row">
									<label for="txtCodigo" class="col-sm-3 text-right control-label col-form-label">Código : </label>
									<div class="col-sm-9">
										<input type="text" class="form-control" id="txtCodigo" placeholder="El código de la moneda que desea registrar aquí" name="txtCodigo">
									</div>
							</div>
							<div class="form-group row">
