...
var urlGlobal={
    ...
    resourcesEntradaSalidaArticulo:url + 'entrada-salida-articulo',
    resourcesMoneda:url + 'moneda',
    resourcesVenta:url + 'venta',
    resourcesProduccion:url + 'produccion',
    resourcesCuenta:url + 'cuenta',
    resourcesCaja:url + 'caja',
    resourcesMovimientoAlmacen:url + 'movimientos-almacen',
    ...
    getArticuloStocksByCodigo:url + 'articulo/stock/codigo/',
    getArticuloStocksByCodigoBarra:url + 'articulo/stock/codigo-barras/',
    ...
    getArticuloByFilters:url + 'articulo/filters',
    ...
    getEntradaSalidaByRangeDate:url + 'entrada-salida-articulo/date-range',
    ...
    forceGetProductionCredits:url + 'produccion/creditos',
    cancelSale:url + 'venta/cancel/',
    getCompraCredito:url + 'compra/creditos/',
    purchaseArrived:url + 'compra/purchase-arrived/',
